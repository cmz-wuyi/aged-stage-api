package cn.age.interaction.helper;
...
public class PageBuilder<T extends Serializable> implements Serializable{
    ...
    public static<T> Pagination buildPageResult(Page<Object> page, List<T> list){
        ...
        Integer total = Integer.valueOf(String.valueOf(page.getTotal())).compareTo(BigInteger.ZERO.intValue()) > 0 ? Integer.parseInt(String.valueOf(page.getTotal())) : 0;
